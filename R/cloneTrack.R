...
#' If set to NULL (default), all repertoire_ids in the sequence matrix will be
#' tracked.
#' @param sequence_track An optional character vector of one or more amino acid
#' sequences to track. If set to NULL (default), will pull all junction_aa
...
#' cloneTrack(study_table = amino_table, sequence_track = top_freq$junction_aa[1:10])
#'
#' # Track clones mapping to the CD4 and CD8 samples while ignoring all others
#' cloneTrack(study_table = amino_table, sample_list = c("TRB_CD4_949", "TRB_CD8_949"))
#'
