...
#' @param repertoire_ids A character vector of two or more repertoire_id names
#'  in study_table.
#' @return Returns a data frame of the common sequences between two or more
#'  files displaying their frequencies in each.
