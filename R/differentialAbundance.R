...
#' P value (also known as the false discovery rate or q value) to subset the results with.
...
#' @param parallel A boolean indicating whether parallel processing should be used or not.
#' The default value is FALSE.
#' @return Returns a data frame with columns corresponding to the frequency of the abundance
#' measure in samples 1 and 2, the P value, Q value (Holms adjusted P value, also known as
