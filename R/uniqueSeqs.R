#' Unique sequences
#'
#' Aggregates all productive sequences within a list of data frames by
#' duplicate_count.
#'
...
#' @param unique_type Use `"junction_aa"` (the default) to aggregate by amino
#'  acid sequences. Use `"junction"` to aggregate by nucleotide sequences.
...
#' @export
uniqueSeqs <- function(productive_table = productive_table,
                       unique_type = "junction_aa") {
