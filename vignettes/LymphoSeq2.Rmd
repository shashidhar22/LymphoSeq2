...
```{r loadMeta}
TCRB_metadata <- dplyr::read.csv(system.file("extdata", "TCRB_metadata.csv", package = "LymphoSeq2"))
TCRB_metadata
```
...
```{r heatmap}
vvGenes <- LymphoSeq2::geneFreq(ntable, locus = "V", family = TRUE) %>% 
           dplyr::pivot_wider(id_cols = gene_name, 
...
pheatmap(vGenes, color = "RdBu", scale = "row")
```
